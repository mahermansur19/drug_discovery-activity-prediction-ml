...
# Remove NaN and duplicate entries
dtfm = dtfm.dropna()
...
# Convert labels to numeric (1 = Active, 0 = Inactive)
...
# Convert fingerprints to array format
import numpy as np
...
# Compute max similarity to training actives
